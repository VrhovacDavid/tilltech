        ...
        <div className="row align-items-start">
          ...
          <div className="col-lg-8">
            ...
            <div className="tab-content ">
              <div id="opt1">
                <h2 className="font-gilroy-bold">AGB</h2>
                <div className="update-date">LETZTES UPDATE: 03/02/2024</div>
                <h3>ÜBERSICHT</h3>
<p>Diese Website wird von TillTech GmbH betrieben. Überall auf der Webseite beziehen sich die Begriffe „wir“, „uns“ und „unsere/e“ auf TillTech GmbH. TillTech GmbH bietet diese Website, einschließlich aller Informationen, Tools und Dienste, die auf dieser Website verfügbar sind, Ihnen, dem Benutzer, unter der Bedingung an, dass Sie alle hier angegebenen Bedingungen, Konditionen, Richtlinien und Hinweise akzeptieren.</p>

<p>Wenn Sie unsere Website besuchen und/oder etwas bei uns kaufen, nutzen Sie unseren „Dienst“ und erklären sich damit einverstanden, an die folgenden Allgemeinen Geschäftsbedingungen („Allgemeine Geschäftsbedingungen“, „Bedingungen“) gebunden zu sein, einschließlich der zusätzlichen Geschäftsbedingungen und Richtlinien, die hierin erwähnt werden und/oder per Hyperlink verfügbar sind. Diese Allgemeinen Geschäftsbedingungen gelten für alle Benutzer der Website, insbesondere Benutzer, die Besucher, Anbieter, Kunden, Händler und/oder Verfasser von Inhalten sind.</p>
...
<p>Sie dürfen unsere Produkte weder für illegale oder nicht autorisierte Zwecke nutzen noch dürfen Sie durch die Nutzung der Serviceleistung gegen Gesetze in Ihrer Gerichtsbarkeit verstoßen (einschließlich, aber nicht beschränkt auf Urheberrechtsgesetze).</p>
...
<p>Sie nehmen zur Kenntnis, dass Ihre Informationen (außer Kreditkarteninformationen) unverschlüsselt übertragen werden können und (a) Übertragungen über verschiedene Netzwerke sowie (b) Änderungen beinhalten können, um den technischen Anforderungen von verbundenen Netzwerken oder Geräten zu entsprechen und sich an diese anzupassen. Kreditkarteninformationen werden bei der Übertragung über Netzwerke immer verschlüsselt.</p>

<p>Sie verpflichten sich, ohne ausdrückliche schriftliche Genehmigung von uns keinen Teil der Serviceleistung, die Nutzung der Serviceleistung oder den Zugriff auf die Serviceleistung oder auf jegliche Kontakte auf der Website, durch die die Serviceleistung angeboten wird, zu reproduzieren, zu vervielfältigen, zu kopieren, zu verkaufen, weiterzuverkaufen oder zu verwerten.</p>

<p>Die in dieser Vereinbarung verwendeten Überschriften dienen nur der Übersichtlichkeit und schränken diese Bedingungen nicht ein oder wirken sich anderweitig auf sie aus.</p>

<h3>ABSCHNITT 3 – GENAUIGKEIT, VOLLSTÄNDIGKEIT UND RECHTZEITIGKEIT DER INFORMATIONEN</h3>
<p>Wir sind nicht verantwortlich, wenn die auf dieser Seite zur Verfügung gestellten Informationen nicht genau, vollständig oder aktuell sind. Das Material auf dieser Website dient nur der allgemeinen Information und sollte nicht als alleinige Grundlage für Entscheidungen herangezogen werden, ohne primäre, genauere, vollständigere oder aktuellere Informationsquellen zu prüfen. Jegliches Vertrauen in das Material auf dieser Website geschieht auf eigene Verantwortung.</p>

<p>Diese Seite enthält möglicherweise gewisse historische Informationen. Historische Informationen sind nicht unbedingt aktuell und werden lediglich zu Ihrer Orientierung bereitgestellt. Wir behalten uns das Recht vor, Inhalte auf dieser Website jederzeit zu ändern, sind aber nicht verpflichtet, irgendwelche Informationen auf unserer Website zu aktualisieren. Sie stimmen zu, dass Sie verantwortlich dafür sind, Änderungen auf unserer Website zu überwachen.</p>
...
<p>Shopify ist weder Ihnen noch Dritten gegenüber haftbar für Änderungen, Preisänderungen, Sperrung oder Einstellung des Serviceleistung.</p>

<h3>ABSCHNITT 5 – PRODUKTE ODER SERVICELEISTUNGEN (falls zutreffend)</h3>
<p>Gewisse Produkte oder Serviceleistungen sind möglicherweise nur online über die Website erhältlich. Diese Produkte oder Serviceleistungen sind unter Umständen nur in begrenzten Mengen vorhanden und unterliegen nur der Rückgabe oder dem Umtausch gemäß unseren Rückgaberichtlinien.</p>

<p>Wir haben uns bemüht, die Farben und Bilder unserer Produkte, die im Shop erscheinen, so genau wie möglich darzustellen. Wir können nicht garantieren, dass Ihr Computerbildschirm jede Farbe korrekt anzeigt.</p>

<p>Wir behalten uns das Recht vor, sind aber nicht verpflichtet, den Verkauf unserer Produkte oder Serviceleistungen auf gewisse Personen, geografische Regionen oder Gerichtsbarkeiten zu beschränken. Wir können dieses Recht von Fall zu Fall ausüben. Wir behalten uns das Recht vor, die Mengen der von uns angebotenen Produkte oder Serviceleistungen zu begrenzen. Alle Produktbeschreibungen oder Produktpreise können jederzeit ohne Vorankündigung und nach unserem alleinigen Ermessen geändert werden. Wir behalten uns das Recht vor, jedes Produkt jederzeit aus dem Angebot zu nehmen. Jedes Angebot für ein Produkt oder eine Serviceleistung, das auf dieser Website gemacht wird, ist ungültig, wo es verboten ist.</p>
...
<p>Diese Allgemeinen Geschäftsbedingungen sowie von uns auf dieser Website oder in Bezug auf die Serviceleistung veröffentlichten Richtlinien oder Betriebsvorschriften, stellen die gesamte Vereinbarung und Übereinkunft zwischen Ihnen und uns dar, regeln Ihre Nutzung der Serviceleistung und ersetzen alle vorherigen oder gleichzeitigen Vereinbarungen, Mitteilungen und Angebote, mündlich oder schriftlich, zwischen Ihnen und uns (einschließlich, aber nicht beschränkt auf vorherige Versionen der Allgemeinen Geschäftsbedingungen).</p>

<p>Etwaige Unklarheiten bei der Auslegung dieser Allgemeinen Geschäftsbedingungen sind nicht gegen die verfassende Partei zu verstehen.</p>

<h3>ABSCHNITT 18 – GELTENDES RECHT</h3>
<p>Diese Allgemeinen Geschäftsbedingungen und alle separaten Vereinbarungen, in deren Rahmen wir Ihnen Serviceleistungen zur Verfügung stellen, unterliegen den Gesetzen von St. Leonhard-Strasse 75, St. Gallen, St. Gallen, 9000, Schweiz und sind nach diesen auszulegen.</p>

<h3>ABSCHNITT 19 – ÄNDERUNGEN DER ALLGEMEINEN GESCHÄFTSBEDINGUNGEN</h3>
<p>Die aktuellste Version der Allgemeinen Geschäftsbedingungen können Sie jederzeit auf dieser Seite einsehen.</p>

<p>Wir behalten uns das Recht vor, jegliche Teile dieser Allgemeinen Geschäftsbedingungen nach eigenem Ermessen zu aktualisieren, zu ändern oder zu ersetzen, indem wir Aktualisierungen und Änderungen auf unserer Website veröffentlichen. Es liegt in Ihrer Verantwortung, unsere Website regelmäßig auf mögliche Änderungen zu überprüfen. Indem Sie unsere Website oder die Serviceleistung nach der Veröffentlichung von Änderungen dieser Allgemeinen Geschäftsbedingungen weiterhin nutzen oder weiterhin darauf zugreifen, gilt dies als Annahme dieser Änderungen.</p>

<h3>ABSCHNITT 20 – KONTAKTDATEN</h3>
<p>Fragen zu den Allgemeinen Geschäftsbedingungen sind unter david.vrhovac@tilltech.ch an uns zu richten.</p>

              </div>
              <div id="opt3">
                <h2 className="font-gilroy-bold">Datenschutz</h2>
                <div className="update-date">LETZTES UPDATE 02/03/2024</div>
